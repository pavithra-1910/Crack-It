...
class Verbal_prac(Screen):
    def __init__(self, **kwargs):
        ...
        header_label = MDLabel(text="Verbal Ability", font_style="H5", halign="center",
        ...
        # Verbal Ability Card
        self.create_card(layout, "Reading Comprehension", "reading.png")
        self.create_card(layout, "Sentence Correction", "sentence.png")
        self.create_card(layout, "Synonyms & Antonyms", "synonyms.png")
        self.create_card(layout, "Para Jumbles", "para.png")
        self.create_card(layout, "Fill in the Blanks", "fill.png")
        self.create_card(layout, "Critical Reasoning", "critical.png")
