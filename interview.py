...
class Interview(Screen):
    def __init__(self,screen_manager, **kwargs):
        ...
        header_label = MDLabel(text="Interview Section", font_style="H5", halign="center",
        ...
        verbal_label = MDLabel(text="Common HR Questions", theme_text_color="Custom", text_color=(1, 1, 1, 1),
                               halign='left', font_style="H6", size_hint=(0.5, 1))

        # Add the image to the right side
        verbal_image = Image(source="hr.webp", size_hint=(None, None), size=(200,200),pos_hint={'x': 0.85,'center_y':0.5})
        ...
        card1.bind(on_release=self.go_to_commonhr)
        ...
        # Add the label to the left side
        logical_label = MDLabel(text="Technical Questions", theme_text_color="Custom", text_color=(1, 1, 1, 1),
                               halign='left', font_style="H6", size_hint=(0.5, 1))

        # Add the image to the right side
        logical_image = Image(source="technical.png", size_hint=(None, None), size=(150, 150),pos_hint={'center_y':0.5})
        ...
        card2.bind(on_release=self.go_to_tech)
        ...
        # Add the label to the left side
        quant_label = MDLabel(text="Group Discusion", theme_text_color="Custom", text_color=(1, 1, 1, 1),
                               halign='left', font_style="H6", size_hint=(0.5, 1))

        # Add the image to the right side
        quant_image = Image(source="mock.webp", size_hint=(None, None), size=(150, 150),pos_hint={'center_y':0.5})
        ...
        card3.bind(on_release=self.go_to_gd)
        ...
        # Add the label to the left side
        tech_label = MDLabel(text="Interview Tips", theme_text_color="Custom", text_color=(1, 1, 1, 1),
                               halign='left', font_style="H6", size_hint=(0.5, 1))

        # Add the image to the right side
        tech_image = Image(source="tips.png", size_hint=(None, None), size=(170, 170),pos_hint={'center_y':0.5})
        ...
        card4.bind(on_release=self.go_to_interviewtip)
        ...
        # Add the label to the left side
        company_label = MDLabel(text="Company-Specific Queations", theme_text_color="Custom", text_color=(1, 1, 1, 1),
                               halign='left', font_style="H6", size_hint=(0.5, 1))
        ...
        card5.bind(on_release=self.go_to_company_specific)
    ...
    def go_to_interviewtip(self,instance):
        self.manager.current = 'interviewtip'

    def go_to_commonhr(self,instance):
        self.manager.current = 'commonhr'

    def go_to_gd(self,instance):
        self.manager.current = 'gd'

    def go_to_tech(self,instance):
        self.manager.current = 'techq'

    def go_to_company_specific(self, instance):
        # Define the URL for the company-specific questions
        url = "https://pavithra-1910.github.io/company/"  # Replace with the actual URL
