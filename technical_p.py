...
class Technical_Prac(Screen):
    def __init__(self, **kwargs):
        ...
        header_label = MDLabel(text="Technical Questions", font_style="H5", halign="center",
        ...
        # Verbal Ability Card
        self.create_card(layout, "Data Structures & Algorithms", "datast.png")
        self.create_card(layout, "Object-Oriented Programming", "oops.png")
        self.create_card(layout, "Operating Systems", "os.png")
        self.create_card(layout, "Database Management Systems", "db.png")
        self.create_card(layout, "Networking & Cloud Computing", "nw.png")
        self.create_card(layout, "System Design", "sys.png")
